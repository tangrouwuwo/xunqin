        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-5 text-center mb-4">
              <img :src="mainPhoto" class="img-fluid rounded shadow-sm" :alt="person.name"
            ...
            <div class="col-md-7">
              <div class="d-flex justify-content-between align-items-start mb-3">
                <h2 class="fw-bold mb-0">{{ person.name }}</h2>
...
const mainPhoto = computed(() => {
  ...
  return list.length > 0 ? list[currentPhotoIndex.value] || list[0] : defaultImage
})
...
const defaultImage = 'images/OIP-C.webp'
